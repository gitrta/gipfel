			...
			?>
				...
				elseif($arProperties["TYPE"] == "TEXT")
				{
					...
					if ( in_array(strtolower($arProperties["CODE"]), $arMail) )
						$type = "email";
					?>
					<input id="<?=$arProperties["FIELD_NAME"]?>" class="form-control" type="<?=$type?>" maxlength="250" size="<?=$arProperties["SIZE1"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" placeholder="¬ведите <?=$arProperties["NAME"]?>" <?=($arProperties["REQUIED"]==="Y")?"required":"";?> >
					<?
				}
				...
				{
					?>
					<textarea id="<?=$arProperties["FIELD_NAME"]?>" class="form-control" rows="<?=$arProperties["SIZE2"]?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" placeholder="¬ведите <?=$arProperties["NAME"]?>" <?=($arProperties["REQUIED"]==="Y")?"required":"";?>><?=$arProperties["VALUE"]?></textarea>
					<?
				}
