...
if (0 < intval($arCurrentValues["IBLOCK_ID"]))
{
	...
	while ($arr=$rsProp->Fetch())
	{
        ...
        $arPropertyAnalog["SECTION_ID"] = GetMessage("SBT_SECTION_ID");
        if($arr["PROPERTY_TYPE"] != "F")
            $arPropertyAnalog["PROPERTY_".$arr["CODE"]] = "[".$arr["CODE"]."] ".$arr["NAME"];
...
$arMode = array("PRODUCT"=>GetMessage("SBT_MODE_PRODUCT"), "BASKET"=>GetMessage("SBT_MODE_BASKET"));
...
$arComponentParameters = array(
	...
	"PARAMETERS" => array(
        ...
        "DETAIL_PROPS_ANALOG" => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage("SBT_ANALOG_PROPS"),
            "TYPE" => "LIST",
            "MULTIPLE" => "Y",
            "DEFAULT" => "SECTION_ID",
            "VALUES" => $arPropertyAnalog,
            "ADDITIONAL_VALUES" => "Y",
        ),
...
if($arCurrentValues['MODE']=="BASKET")
{
