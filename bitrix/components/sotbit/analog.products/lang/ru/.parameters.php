...
$MESS["SRP_CODE"] = "Символьный код";

$MESS["SBT_MODE"] = "Режим работы";
$MESS["SBT_MODE_PRODUCT"] = "Товар";
$MESS["SBT_MODE_BASKET"] = "Корзина";

$MESS["SBT_ANALOG_PROPS"] = "Параметры, по которым фильтруются похожие товары";
$MESS["SBT_SECTION_ID"] = "Раздел-родитель";
$MESS["SBT_ANALOG_PRICE"] = "Раздел-родитель";
$MESS["SBT_ANALOG_HIDE_NOT_AVAILABLE"] = "Не отображать товары, которых нет на складах";
$MESS["SBT_ANALOG_SORT_FIELD"] = "По какому полю сортируем элементы";
$MESS["SBT_ANALOG_SORT_ORDER"] = "Порядок сортировки элементов";
$MESS["IBLOCK_SORT_ASC"] = "по возрастанию";
$MESS["IBLOCK_SORT_DESC"] = "по убыванию";
?>