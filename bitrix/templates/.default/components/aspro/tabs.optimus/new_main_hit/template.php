	...
	if($arResult["SHOW_SLIDER_PROP"]){?>
		<div class="tab_slider_wrapp specials <?=$class_block;?> best_block clearfix">
			...
			<ul class="tabs_content">
				<?$j=1;?>
				<?foreach($arResult["TABS"] as $code=>$title){print_r($code);?>
					<li class="tab <?=$code?>_wrapp <?=($j++ ==1 ? "cur" : "");?>" data-code="<?=$code?>" data-col="<?=$col;?>">
						<div class="tabs_slider <?=$code?>_slides wr">
							...
							if($code == "BEST") $srtof = 'SORT'; else $srtof = $arParams["ELEMENT_SORT_FIELD"];
							if($code == "BEST") $srtof2 = 'SORT'; else $srtof2 = $arParams["ELEMENT_SORT_FIELD2"];
							?>
							<?$APPLICATION->IncludeComponent(
								...
								array(
									...
									"ELEMENT_SORT_FIELD" => $srtof,
									"ELEMENT_SORT_ORDER" => $arParams["ELEMENT_SORT_ORDER"],
									"ELEMENT_SORT_FIELD2" => $srtof2,
