...
?>
            <div class="bestsellers">
                <div class="page_title">Хиты продаж</div>
                <!--<div class="page_title_capt">Лидеры продаж посуды Gipfel</div>-->



<? if (!empty($arResult['ITEMS'])): ?>
                <ul class="bestsellers_list">
	<?
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		$strMainID = $this->GetEditAreaId($arItem['ID'] . $key);
if (1>$arItem['CATALOG_QUANTITY']) continue;
		$arItemIDs = array(
			'ID' => $strMainID,
		...
		?>
	<li class="bestsellers_item bestsellers_item_best <? echo($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"
		id="<? echo $strMainID; ?>">
                        <div class="bestsellers_item_image" >
                            <?if($arItem['PREVIEW_PICTURE']['SRC']):?><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><img  src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt=""></a><?endif?>
                        </div>		
	<div class="">
	...
	{
		?>
                        <div class="bestsellers_item_title"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
	...
	<div class="bx_catalog_item_price">
		<div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price bestsellers_price"><?
			if (!empty($arItem['MIN_PRICE']))
			{
				...
				{
					?><span class="old"><? echo number_format($arItem['PROPERTIES']['OLD_PRICE']['VALUE'], 0, ' ', ' ')?> руб.</span><?
				}
			}
			?></div>
	</div><?
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS'])) // Simple Product
	{
		...
		<div class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				?>
				<div class="bx_catalog_item_controls_blocktwo0">
					<a class="bestsellers_button best list js-action-buy" data-buy="action=buy&id=<?=$arItem['ID']?>"
						href="javascript:void(0)" rel="nofollow" onclick="SendAnalyticsGoal('kupit_katalog')"><?
	...
	?>
		<div class="bx_catalog_item_controls no_touch">
			...
			?>
			<div class="bx_catalog_item_controls_blocktwo">
				<a class="bx_bt_button js-buy bx_medium bestsellers_button"
