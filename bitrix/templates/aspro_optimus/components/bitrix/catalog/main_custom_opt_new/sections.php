...
$_GET[$arParams["FILTER_NAME"]."_1839_2529356741"] = "Y";
//$_GET[$arParams["FILTER_NAME"]."_75_2927112411"] = "Y";
...
<?if($TEMPLATE_OPTIONS["TYPE_VIEW_FILTER"]["CURRENT_VALUE"]=="VERTICAL"){?>
	<?ob_start()?>
		<div class="new_block"><?include_once("filter.php")?></div>
	<?$html=ob_get_clean();?>
...
<div class="right_block1 clearfix catalog <?=strtolower($TEMPLATE_OPTIONS["TYPE_VIEW_FILTER"]["CURRENT_VALUE"]);?>" id="right_block_ajax">
	...
	<?}
	if(isset($GLOBALS[$arParams["FILTER_NAME"]]["FACET_OPTIONS"]) && $GLOBALS[$arParams["FILTER_NAME"]]["FACET_OPTIONS"])
	...
	<div class="inner_wrapper">
		...
		<?}?>
			<?$GLOBALS['filter_new'] = array('PROPERTY_NOVINKA' => 'НОВИНКА'); 
