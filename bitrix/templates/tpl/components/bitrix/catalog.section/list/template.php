...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="catalog_item list <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"><div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
                            <div class="catslog_item_photo">
							<?
...
<?foreach($arItem['PROPERTIES']['MORE_PHOTO']['VALUE'] as $k=>$v):
		if ($k==2) break;
		$src=CFile::GetPath($v);?>							
...
<?endif?>
							...
							<div class="catalog_item_info">
                                <div class="catalog_item_info_left">
                                    <div class="catalog_item_title"><a href="<?=$arItem['DETAIL_PAGE_URL']?>"><?=$arItem['NAME']?></a></div>
...
?>
                                ...
                                <div class="catalog_item_info_right">                               
<div id="<? echo $arItemIDs['PRICE']; ?>" class="catalog_item_grid_short_price bx_price"><?
	if (!empty($arItem['MIN_PRICE']))
	{
		...
		{
			?>                                     <div class="product_old_price"><? echo $arItem['MIN_PRICE']['PRINT_VALUE']; ?></div><?
		}
	}
	?></div>
<?
		...
		<div class="bx_catalog_item_controls_blockone"><div style="display: inline-block;position: relative;">
			...
			?>
			                                    ...
			                                    <div class="product_options">
															<a data-buy="id=<?=$arItem['ID']?>&amp;action=buy" id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium0 js-action-buy product_buy" href="javascript:void(0)" rel="nofollow"><?
...
<?if($arItem['PROPERTIES']['MORE_PHOTO']['VALUE']):?>	
<?foreach($arItem['PROPERTIES']['MORE_PHOTO']['VALUE'] as $v):$src=CFile::GetPath($v);?>							
                                    <div class="product_small_photo">
                                        <a href="<?=$src?>"><img src="<?=$src?>" alt=""></a>
                                    </div>
<?endforeach?>									
