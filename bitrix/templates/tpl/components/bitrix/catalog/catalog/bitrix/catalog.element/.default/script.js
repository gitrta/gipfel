function findActive() {
	$(".product_small_photo").each(function(i,el){
		if($(el).find("a").hasClass("zoomThumbActive")) $(el).addClass("active");
		else $(el).removeClass("active");
	});
}
$(function(){
	/*$(".product_small_photo a").click(function(){
		$(".product_small_photo").removeClass("active");
		$(this).closest(".product_small_photo").addClass("active");
	});
	$(".product_small_photo a").hover(function(){
		$(this).trigger("click");
	});*/
});
