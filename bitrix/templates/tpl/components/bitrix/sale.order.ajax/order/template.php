...
?>
		<div class="blockCity">
							<h2>Адрес доставки <!--<p>указать на <a href="#bottom">карте</a></p>--> </h2>		
		<?
		...
		<?
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"],ARRAY("STREET"));
...
<div class="blockComment">
                            ...
                            <div class="order_col1">   
                                <div class="order_label">Оставьте свой комментарий или дополнительную информацию</div>
...
<textarea name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
			<input type="hidden" name="" value="">
							...
							<?
							/*if ($arResult['JS_DATA']['TOTAL']['ORDER_PRICE'] < 1500) {
								echo '<div class="errortext">Минимальный заказ 1500р</div>';
							}*/?>
							<div style="margin-bottom: 5px"></div>

                            <div class="order_submit">
                                <input type="submit"  value="Оформить заказ" <?/*=($arResult['JS_DATA']['TOTAL']['ORDER_PRICE'] < 1500?'disabled class="disabled"':'')*/?> onclick="submitForm('Y'); return false;">
                            </div>	
</div>							
			<?
