...
?>
<div
	class="bx_item_list_bestsellers bestsellers col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>"
 style="padding: 0 9px 12px;"
>
    <div class="page_title_hp">Хиты продаж</div>
...
<? if (!empty($arResult['ITEMS'])): ?>
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
	   ...
	   if($arItem["IBLOCK_SECTION_ID"]==9 or $arItem["IBLOCK_SECTION_ID"]==53 or $arItem["IBLOCK_SECTION_ID"]==44 or $arItem["IBLOCK_SECTION_ID"]==50
	    or $arItem["IBLOCK_SECTION_ID"]==52 or $arItem["IBLOCK_SECTION_ID"]==49 or $arItem["IBLOCK_SECTION_ID"]==43 or $arItem["IBLOCK_SECTION_ID"]==51
		 or $arItem["IBLOCK_SECTION_ID"]==48
	   ){
		...
		?>
	<li class="bestsellers_item <? echo($arItem['SECOND_PICT'] && $arParams ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>"
		id="<? echo $strMainID; ?>">
		...
		<div class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				<div class="bx_catalog_item_controls_blocktwo">
					<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bestsellers_button"
	...
	?>
		<div class="bx_catalog_item_controls no_touch">
			...
			?>
			<div class="bx_catalog_item_controls_blocktwo">
				<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium bestsellers_button"
