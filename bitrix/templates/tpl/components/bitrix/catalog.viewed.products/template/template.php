...
$frame = $this->createFrame('#ITEM#_prop_'.$arProp['ID'].'_list')->begin();
...
<?$frame->end();?>
	...
	?>
        ...
        <div class="seen">
            <div class="wrapper">
                <div class="seen_title">вы смотрели</div>
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)
	{
		...
		?>
                    <li class="bestsellers_item" id="<? echo $strMainID; ?>">
	<?
		if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT0'])
		{
			?>
			<div
		...
		?>					
                        <div class="bestsellers_item_image">
                            <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"><img title="<? echo $strTitle; ?>" src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt=""></a>
                        </div>
		...
		<div class="bx_catalog_item_controls"><?
			if ($arItem['CAN_BUY'])
			{
				...
				<div class="bx_catalog_item_controls_blocktwo">
					<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bestsellers_button viewed list js-action-buy"
					onclick="SendAnalyticsGoal('kupit_katalog');"
					data-buy="action=buy&id=<?=$arItem['ID']?>"
