...
$arItem['PREVIEW_PICTURE']['SRC'] = $renderImage['src'];
	...
	<div class="catalog_item grid <? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>" style="float: left;margin-right: 0px;margin-left:15px;">
...
<div class="bx_catalog_item_controls"><?
		...
		<div class="bx_catalog_item_controls_blockone"><div style="display: inline-block;position: relative;">
			...
			?>
		<div class="bx_catalog_item_controls_blocktwo">
			<a data-buy="id=<?=$arItem['ID']?>&action=buy" id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium0 js-action-buy product_buy list" href="" rel="nofollow"><?
			echo ('' != $arParams['MESS_BTN_BUY'] ? $arParams['MESS_BTN_BUY'] : GetMessage('CT_BCS_TPL_MESS_BTN_BUY'));
			?></a>
		</div>
			<?
