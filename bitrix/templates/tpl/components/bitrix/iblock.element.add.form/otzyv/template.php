	...
	<?if ($arParams["MAX_FILE_SIZE"] > 0):?><input type="hidden" name="MAX_FILE_SIZE" value="<?=$arParams["MAX_FILE_SIZE"]?>" /><?endif?>
		...
		?>
			...
			<?if($arParams["USE_CAPTCHA"] == "Y" && $arParams["ID"] <= 0):?>
					...
					<div class="reviews_form_label"><?=GetMessage("IBLOCK_FORM_CAPTCHA_TITLE")?></div>
					<div class="reviews_form_input">
						<input type="hidden" name="captcha_sid" value="<?=$arResult["CAPTCHA_CODE"]?>" />
						<img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["CAPTCHA_CODE"]?>" width="180" height="40" alt="CAPTCHA" />
					
					</div>
					<div class="reviews_form_label"><?=GetMessage("IBLOCK_FORM_CAPTCHA_PROMPT")?><span class="starrequired">*</span>:</div>
					<div class="reviews_form_input"><input type="text" name="captcha_word" maxlength="50" value=""></div>
				
			<?endif?>
		</tbody>
		<?endif?>
                            <div class="review_form_submit"> <input name="iblock_submit" type="hidden" value="Добавить отзыв">
