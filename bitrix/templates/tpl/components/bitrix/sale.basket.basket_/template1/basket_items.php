...
<?/*<tr>
	...
	<div class="bx_ordercart_photo" style="background-image:url('<?=SITE_TEMPLATE_PATH?>/images/data/10.jpg')"></div>
								...
								<td class="item">
									<div class="cart_table_item_product_info_title">
										<a href="#" class="js-back">Ваш подарок-сюрприз от Gipfel оформите заказ и получите подарок										</a>									</div>
									<div class="cart_table_item_product_description">
									Бесплатный подарок
																			</div>
																	</td>
			...
			<div class="bx_ordercart_coupon">
                ...
                <div class="cart_bottom">
                    ...
                    <div class="cart_deliv_price_block">
                        СТОИМОСТЬ ДОСТАВКИ: <span class="cart_deliv_price">200<span>руб</span></span>
                    </div>-->
                    ...
                    <div class="cart_table_item">
                        <div class="cart_table_item_product">
                            ...
                            <div class="cart_table_item_product_info">
                                <div class="cart_table_item_product_info_title"><a href="#" class="js-back">Ваш подарок-сюрприз от Gipfel оформите заказ и получите подарок</a></div>
                                <div class="cart_table_item_product_description">
                                    Бесплатный подарок
                                </div>
                            </div>
