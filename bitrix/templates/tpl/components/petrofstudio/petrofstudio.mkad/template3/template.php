...
<script>
	$(function () {
		$(document).on('submit', '#ORDER_FORM',function (e) {
			var isset = $('input[name=confirmorder]').val() == "Y";
			if(isset) {
				$('#order-page').hide();
				$('.preloader').show();

				console.log($('input[name=confirmorder]').val());
				setTimeout(function () {
...
<div class="wrapper main " id="order-page">  
...
<div class="hero-unit">
	<div class="container-fluid">
        <div class="row-fluid">
            <div id="YMapsID" class="span12"></div>
            <div id="sidebar2" class="span4 hidden">
