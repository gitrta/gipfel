								...
								<div class="inner_wrap">
									<div class="image_wrapper_block">
										...
										<?if( !empty($arItem["PREVIEW_PICTURE"]) ):?>
											...
											<div class = "backim" style = "height:100px; background: url('<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>');"></div>
										<?elseif( !empty($arItem["DETAIL_PICTURE"])):?>
											<?$img = CFile::ResizeImageGet($arItem["DETAIL_PICTURE"], array( "width" => 100, "height" => 100 ), BX_RESIZE_IMAGE_PROPORTIONAL,true );?>
										...
										<?else:?>
											...
											<div class = "backim" style = "height:100px; background: url('<?=SITE_TEMPLATE_PATH?>/images/no_photo_medium.png');"></div>
										<?endif;?>
									</a>
									</div>
									<div class="item_info">
										...
										<div class="cost prices clearfix">
											...
											<?}elseif ( $arItem["PRICES"] ){ $newval = CCurrencyRates::ConvertCurrency($arPrice['UNROUND_DISCOUNT_VALUE'], "RUB", 'KZT'); ?>
