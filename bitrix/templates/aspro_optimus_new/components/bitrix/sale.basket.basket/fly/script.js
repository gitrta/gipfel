...
function setQuantity(basketId, ratio, direction){
	...
	var valut = $('.cost-cell span').text();	
		...
		$('#basket_line .basket_fly tr[data-id='+basketId+']').closest('table').find("tbody tr[data-id]").each(function(i, element) {
			...
			//alert(valut);
			$(document).find("#basket_form [data-id="+id+"] .summ-cell .price").html(formatPrice(sum.toFixed(0))+' '+valut);
		});

		$("#basket_form .itog span.price").html(formatPrice(totalSum.toFixed(0))+' '+valut);
