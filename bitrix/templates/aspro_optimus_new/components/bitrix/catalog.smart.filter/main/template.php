				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
					...
					if(isset($arItem["PRICE"])):
						...
						<div class="bx_filter_parameters_box active">
							...
							<?
							$impath = '/upload/IMPROP/'.$arItem['CODE'].'.png';
							$icon = file_exists($_SERVER['DOCUMENT_ROOT'].$impath) ? '<img class = "propico" src = "'.$impath.'">' : '';
							?>
							<div class="bx_filter_parameters_box_title icons_fa" ><? echo $icon; ?><?=GetMessage("PRICE")//$arItem["NAME"]?></div>
