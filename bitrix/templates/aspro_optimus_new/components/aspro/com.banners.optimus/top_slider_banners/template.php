...
<li data-href="/catalog/kukhonnye-prinadlezhnosti/razdelka-i-izmelchenie/nabory-nozhey/" class="f22" style="background-image: url(&quot;/upload/iblock/fc8/fc848d74eb450d6e09405b8b6af05695.png&quot;) !important; width: auto; float: left; opacity: 1;">
				

					<!--13579													<a class="target" href="/catalog/kukhonnye-prinadlezhnosti/razdelka-i-izmelchenie/nabory-nozhey/" target="_self"></a>
						-->
			...
			<li data-href="/catalog/posuda-dlya-prigotovleniya/posuda-dlya-zapekaniya/nabory-dlya-barbekyu/" class="f22" style="background-image: url(&quot;/upload/iblock/a38/a381590f3f990085b4cdcd016faa2c5b.png&quot;) !important; width: auto; float: left; display: block; opacity: 1;">
				

					<!--13541													<a class="target" href="/catalog/posuda-dlya-prigotovleniya/posuda-dlya-zapekaniya/nabory-dlya-barbekyu/" target="_self"></a>
						-->
							<div class="wrapper_inner">	
																<table class="table-no-border">
									<tbody><tr>
				...
				<?foreach($arResult["ITEMS"] as $arItem):?>
					...
					<li data-href="<?=$arItem["PROPERTIES"]["URL_STRING"]["VALUE"]?>" class="box<?=($arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] ? " ".$arItem["PROPERTIES"]["TEXTCOLOR"]["VALUE_XML_ID"] : "");?><?=($arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] ? " ".$arItem["PROPERTIES"]["TEXT_POSITION"]["VALUE_XML_ID"] : " left");?>" id="<?=$this->GetEditAreaId($arItem['ID']);?>" style="background-image: url('<?=$background?>') !important;">
