...
$APPLICATION->SetPageProperty("description", "Посуда Gipfel большой ассортимент, который не перестает удивлять покупателей Гипфел своим разнообразием.Флагманский интернет магазин Gipfel");
