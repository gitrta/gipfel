...
//$('#buyer').hide();
//$('.buyer').text('Выберите способ доставки');
        ...
        $('#delvar').on('click', 'div', function(e) {
          //  $('#buyer').show();
//$('.buyer').text('Данные пользователя');
            ...
            $('#delvar > div').attr("style", "background: white; color: #13245e;");
            $(this).addClass('act'); 
...
function SetDelId() {
        ...
        function onAjaxSuccess(data) {
            $('#delvar').html(data);
            $('#delvar > div:last-child').trigger( "click" );



setTimeout( $('#delvar > div:last-child').trigger( "click" ), 4000);
//$('#buyer').hide();
//$('.buyer').text('Выберите способ доставки');
        }
        pay($('.whou').attr('idt'));
